...
**Menu bar capsule** — всегда на виду, цена за сегодня:

![menubar capsule](docs/screenshots/menubar-capsule.png)

**Popover** — клик по capsule открывает дроп с детализацией. Floating island внизу переключает категорию (AI / GitHub / Друзья) и период (День / Неделя / Месяц):

| AI | GitHub | Друзья |
|---|---|---|
| ![ai](docs/screenshots/popover-ai.png) | ![github](docs/screenshots/popover-github.png) | ![leaderboard](docs/screenshots/popover-leaderboard.png) |

**Виджеты** на десктопе — Small / Medium / Large:

| Small | Medium | Large |
|---|---|---|
| ![small](docs/screenshots/widget-small.png) | ![medium](docs/screenshots/widget-medium.png) | ![large](docs/screenshots/widget-large.png) |

**Settings** — общие настройки + свой аккаунт:

| Общие | Аккаунт |
|---|---|
| ![general](docs/screenshots/settings-general.png) | ![account](docs/screenshots/settings-account.png) |
